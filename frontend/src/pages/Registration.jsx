    ...
    >
      ...
      <div className="relative z-10 bg-black bg-opacity-70 md:border-2 border-gray-600 py-8 lg:py-16 px-5 md:px-12 lg:px-12 rounded-2xl shadow-xl max-w-xl md:max-w-3xl lg:max-w-4xl w-full">
        ...
        <div className="mb-8 text-white flex flex-col gap-3">
          <h2 className="text-3xl font-bold mb-3 text-blue-200 text-center">Welcome to HoodShop Registration!</h2>

          <p className="text-white text-lg lg:text-xl text-center">Registration is quick and easy – get started now!</p>
          ...
          <p className="mb-3 text-blue-200 text-lg lg:text-xl text-center">
