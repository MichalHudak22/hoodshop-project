  ...
  useEffect(() => {
   ...
   const handleAddToCart = async () => {
    try {
      ...
      refreshCartCount();
      setMessage("Produkt bol pridaný do košíka!"); // ✅ nastav hlášku
      setTimeout(() => setMessage(''), 3000); // automaticky zmizne po 3s
    } catch (err) {
      console.error('Nepodarilo sa pridať produkt do košíka:', err);
      setMessage("Chyba pri pridávaní do košíka."); // error hláška
