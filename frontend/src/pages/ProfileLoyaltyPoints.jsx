...
function ProfileLoyaltyPoints() {
  ...
  // ✅ Načítanie profilu
  useEffect(() => {
    if (loading) return; // čakáme na overenie tokenu

    if (!user || !user.token) {
      navigate('/login'); // presmerovanie, ak nie je user
      return;
    }
    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        <div className="max-w-5xl mx-auto bg-black bg-opacity-50 md:bg-opacity-70 shadow-md lg:rounded-2xl py-6 lg:py-10 p-3 lg:p-6 lg:mt-10 text-gray-800 lg:border-2 border-gray-600">
          ...
          <p className="mb-4 text-white">
            With every purchase, you automatically earn <strong>loyalty points</strong>. The amount you receive equals <strong>5% of your total order value</strong>.
          </p>
          ...
          <p className="font-medium text-center mt-6 text-white">
            💡 Loyalty points are our way of saying <strong>thank you</strong> for your trust and continued support.
          </p>
        </div>
      </div>
    </div>
