...
const handleAddToCart = async (jersey) => {
  ...
  return (
    <div>
      {/* HEAD TITLE */}
      <section
        className="relative text-center py-4 px-4 bg-gradient-to-br from-orange-400 via-black to-orange-400 text-white overflow-hidden border-b-4 border-black"
      >
        <div className="absolute inset-0 bg-[url('/img/cycling-bg.jpg')] bg-cover bg-center opacity-20"></div>
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-lg md:text-2xl lg:text-3xl font-bold mb-4 tracking-wide drop-shadow-md">
