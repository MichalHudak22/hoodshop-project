...
function Login() {
  ...
  return (
    ...
    >
      ...
      {/* Form container */}
      <div className="relative z-10 lg:bg-black lg:bg-opacity-70 md:border-2 border-gray-600 rounded-2xl shadow-xl w-full max-w-xl md:max-w-3xl lg:max-w-4xl mx-4 p-6 md:p-12 lg:p-16">
