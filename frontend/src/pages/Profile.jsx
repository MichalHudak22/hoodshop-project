  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        ...
        {/* Delete Form */}
        <div className="p-6 my-10 flex flex-col md:flex-row md:items-center md:justify-center w-full md:w-[90%] lg:w-[85%] xl:w-[1240px] text-white md:border-2 border-gray-600 bg-black bg-opacity-50 md:bg-opacity-70 gap-4">
