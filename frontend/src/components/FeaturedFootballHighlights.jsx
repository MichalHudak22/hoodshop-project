...
const FeaturedFootballHighlights = () => {
  ...
  return (
    <section
      className="lg:py-12 w-full bg-fixed"
      style={{
    ...
    >
      <div className="xl:w-[80%] 2xl:w-[65%] m-auto lg:bg-black lg:bg-opacity-50 xl:border-[7px] xl:border-black xl:pb-8 xl:rounded-xl">
