        ...
        {slides.map((slide, index) => {
          ...
          return (
            <SwiperSlide key={index}>
              <div className="w-full h-full bg-gray-100 flex flex-col items-center justify-center p-4 text-center hover:shadow-xl transition relative">
                ...
                <Link to={`/product/${productSlug}`} className="block">
                  <img
                    src={imageUrl}
                    alt={slide.name}
                    className="h-[150px] lg:h-[180px] mb-2 transition duration-300 hover:brightness-110"
                  />
                </Link>
